...
import {AppLoginType, LoginReducer} from "../features/TodolistsList/Login/LoginReducer";
...
export type AppActionsType = TasksActionType | TodolistsActionType | AppStatusType | AppLoginType
